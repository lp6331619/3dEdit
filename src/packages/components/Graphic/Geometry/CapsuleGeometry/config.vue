...
<template>
  ...
  <setting-item-box name="中间区域长度" >
    ...
    <setting-item >
      <n-input-number v-model:value="childrenData[0].config.args[1]"  :step="0.1" :min="0" size="small"></n-input-number>
    </setting-item>
  </setting-item-box> 
