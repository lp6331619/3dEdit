...
export const OctahedronGeometryConfig: ConfigType = {
  key: 'OctahedronGeometry',
  chartKey: 'VOctahedronGeometry',
  conKey: 'VCOctahedronGeometry',
  title: '八面缓冲几何体',
  category: ChatCategoryEnum.GEOMETRY,
  categoryName: ChatCategoryEnumName.GEOMETRY,
  package: PackagesCategoryEnum.GRAPHIC,
  chartFrame: ChartFrameEnum.COMMON,
  image: 'OctahedronGeometry.png'
}
