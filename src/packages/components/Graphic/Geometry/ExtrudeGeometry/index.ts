 ...
 * @LastEditTime: 2024-11-16 17:46:25
...
export const ExtrudeGeometryConfig: ConfigType = {
  key: 'ExtrudeGeometry',
  chartKey: 'VExtrudeGeometry',
  conKey: 'VCExtrudeGeometry',
  title: '挤压缓冲几何体',
  category: ChatCategoryEnum.GEOMETRY,
  categoryName: ChatCategoryEnumName.GEOMETRY,
  package: PackagesCategoryEnum.GRAPHIC,
  chartFrame: ChartFrameEnum.COMMON,
  image: 'ExtrudeGeometry.png'
}
