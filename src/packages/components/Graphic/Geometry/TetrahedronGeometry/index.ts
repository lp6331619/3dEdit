...
export const TetrahedronGeometryConfig: ConfigType = {
  key: 'TetrahedronGeometry',
  chartKey: 'VTetrahedronGeometry',
  conKey: 'VCTetrahedronGeometry',
  title: '四面缓冲几何体',
  category: ChatCategoryEnum.GEOMETRY,
  categoryName: ChatCategoryEnumName.GEOMETRY,
  package: PackagesCategoryEnum.GRAPHIC,
  chartFrame: ChartFrameEnum.COMMON,
  image: 'TetrahedronGeometry.png'
}
